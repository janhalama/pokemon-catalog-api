...
export class Migration20250711165121 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table "pokemon" ("id" varchar(255) not null, "name" varchar(100) not null, "classification" varchar(100) not null, "types" jsonb not null, "resistant" jsonb not null, "weaknesses" jsonb not null, "weight" jsonb not null, "height" jsonb not null, "flee_rate" real not null, "evolution_requirements" jsonb not null, "evolutions" jsonb not null, "max_cp" int not null, "max_hp" int not null, "attacks" jsonb not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "pokemon_pkey" primary key ("id"));`);
    this.addSql(`create index "pokemon_types_index" on "pokemon" ("types");`);
    this.addSql(`create index "pokemon_name_index" on "pokemon" ("name");`);

    this.addSql(`create table "favorites" ("id" serial primary key, "user_id" int not null, "pokemon_id" varchar(255) not null, "created_at" timestamptz not null);`);
